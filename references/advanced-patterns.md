...
8. [Color System Best Practices](#color-system-best-practices)
9. [Font Recommendations](#font-recommendations-non-default-choices)
10. [Color × Font Pairing Reference](#color--font-pairing-reference)
11. [Chinese Typography 中文字体方案](#chinese-typography-中文字体方案)
...
|---|---|---|---|
| Modern tech | `oklch(0.55 0.25 250)` blue-violet | Space Grotesk + Outfit | SaaS, dev tools, AI products |
...
## Chinese Typography (中文字体方案)

> For any interface with Chinese content, always declare an explicit Chinese font stack. Never rely on browser default CJK fallback — it renders as Song Ti on Windows (宋体) and looks dated on every platform.

### System Font Stack (no loading, zero latency)

```css
:root {
  --font-chinese: "PingFang SC", "Microsoft YaHei", "Noto Sans CJK SC",
                  "Source Han Sans SC", sans-serif;
  --font-chinese-serif: "Songti SC", "STSong", "SimSun",
                        "Noto Serif CJK SC", serif;
}

body {
  font-family: var(--font-chinese);
  /* For mixed CJK+Latin, always declare the Latin font FIRST,
     then fall through to the Chinese stack */
  font-family: "Space Grotesk", var(--font-chinese);
}
```

### Web Fonts via Google Fonts (CDN)

> ⚠️ Chinese web fonts are 2–6 MB each. Always use `font-display: swap` and load only what is needed. Prefer system fonts for body text; use web fonts for headings only.

```html
<!-- 思源黑体 Noto Sans SC — clean, authoritative, modern Chinese sans-serif -->
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+SC:wght@400;500;700&display=swap" rel="stylesheet">

<!-- 思源宋体 Noto Serif SC — editorial, high-quality Chinese serif -->
<link href="https://fonts.googleapis.com/css2?family=Noto+Serif+SC:wght@400;600;700&display=swap" rel="stylesheet">

<!-- 霞鹜文楷 LXGW WenKai — calligraphic warmth, very popular for content sites -->
<link href="https://fonts.googleapis.com/css2?family=LXGW+WenKai&display=swap" rel="stylesheet">
<!-- If Google Fonts is blocked, use Chinese CDN instead: -->
<!-- <link href="https://cdn.staticfile.org/lxgw-wenkai-webfont/1.7.0/style.min.css" rel="stylesheet"> -->
```

### Chinese × Latin Pairing Reference

| Style | Chinese Font | Latin Font | Best For |
|---|---|---|---|
| Modern product | Noto Sans SC | Space Grotesk | SaaS, dashboards, app UIs |
| Editorial / content | Noto Serif SC | Newsreader | Blogs, long-form, magazines |
| Premium brand | Noto Serif SC | Sora | Luxury goods, finance, consulting |
| Warm creative | LXGW WenKai | Newsreader | Education, food, personal brands |
| Tech minimal | Noto Sans SC | Outfit | B2B tools, data products |
| Consumer/lifestyle | Noto Sans SC | Plus Jakarta Sans | E-commerce, social, lifestyle |

### Mixed CJK+Latin Font Stack Template

```css
:root {
  /* Declare Latin first so Latin characters use the Latin font;
     CJK characters fall through to the Chinese font automatically */
  --font-sans: "Space Grotesk", "Noto Sans SC", "PingFang SC",
               "Microsoft YaHei", sans-serif;
  --font-serif: "Newsreader", "Noto Serif SC", "Songti SC",
                "STSong", serif;
...
- **Line height**: Chinese body text needs more breathing room than Latin — use `line-height: 1.8` minimum (vs 1.5 for Latin)
- **Letter spacing**: Slight positive tracking on Chinese headings (`letter-spacing: 0.05em`) improves legibility at large sizes
- **Font weight**: Chinese fonts render heavier than Latin at the same weight; use `font-weight: 400` for Chinese body where you'd use `300` for Latin
- **Punctuation**: Chinese uses full-width punctuation (，。！？「」) — never mix half-width ASCII punctuation in Chinese body text
- **Minimum size**: 14px for Chinese body text (vs 16px Latin); characters are more complex and compress poorly below this threshold
